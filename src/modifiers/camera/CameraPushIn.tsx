/**
 * CameraPushIn — slow zoom toward the content (or a focal point).
 *
 * params:
 *   fromScale (1.0), toScale (1.15)
...
export const CameraPushIn: React.FC<ModifierComponentProps> = ({
  modifier,
  sceneDurationFrames,
  children,
}) => {
  ...
  const toScale = readNumber(params, "toScale", 1.15);
